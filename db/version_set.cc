...
class FilePicker {
 public:
  FilePicker(const Slice& user_key, const Slice& ikey,
      ...
      : effective_curr_level_(static_cast<unsigned int>(-1)),
  ...
  int GetEffectiveCurrentLevel() const { return effective_curr_level_; }
 ...
 private:
  unsigned int effective_curr_level_; // skipping empty levels
